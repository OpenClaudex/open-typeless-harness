...
const REPO_URL = 'https://github.com/OpenClaudex/open-typeless-harness';
const RELEASE_NOTES_URL = `${REPO_URL}/releases`;
const HELP_DOCS_URL = `${REPO_URL}#readme`;
...
export function FloatingShell({ os: osProp, initialTab = 'overview', initialSettings = false }: FloatingShellProps) {
  ...
  return (
    <WindowChrome os={os} title="Open Typeless Harness" height="100%">
  ...
  return (
    <div style={{ flex: 1, position: 'relative', display: 'flex', flexDirection: 'column', minHeight: 0, paddingTop: os === 'mac' ? 28 : 0 }}>
      ...
      <div
        ...
        <FooterIcon name="mail" tip={t('shell.footer.feedback')} onClick={() => openExternal(`${REPO_URL}/issues`)} />
  ...
  return (
    <div style={{ minWidth: 240 }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 8 }}>
        ...
        <div>
          <div style={{ fontSize: 13, fontWeight: 600, color: 'var(--ol-ink)' }}>{t('app.name')}</div>
