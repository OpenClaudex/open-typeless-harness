...
export const en: typeof zhCN = {
  ...
  overview: {
    kicker: 'HARNESS',
    title: 'Adaptive voice input',
    desc: 'Dictate into any app, polish with an LLM, then learn quietly from post-insertion edits.',
    loopTitle: 'Self-improving input loop',
    loopDesc: 'ASR transcript -> LLM polish -> focused-field edit monitor -> speech-skill memory for the next dictation.',
    loopAsr: 'ASR',
    loopPolish: 'Polish',
    loopMonitor: 'Monitor',
    ...
    learningDesc: 'Local evidence from post-insertion edits. It shows what the harness captured, what became candidates, and whether guardrails protected the learning stream.',
    ...
    learningCandidatesTitle: 'Recent candidates',
    learningSignalsTitle: 'Recent guardrails',
