...
export const en: typeof zhCN = {
  app: {
    name: 'Open Typeless Harness',
    tagline: 'Adaptive voice input that learns your corrections',
  },
  common: {
    loading: 'Loading…',
    refresh: 'Refresh',
  ...
  shell: {
    ...
    betaTag: 'BETA',
    betaNote: 'Edit monitor and speech-skill learning are local preview features.',
    footer: {
      account: 'Account',
      feedback: 'Feedback',
      settings: 'Settings',
      ...
      helpPopover: {
        tagline: 'Self-improving voice input harness',
  ...
  onboarding: {
    welcome: 'Welcome to Open Typeless Harness',
    intro: 'Speak, polish, insert, then learn locally from your corrections. Two system permissions are needed before you start.',
    ...
    accessibilityHint: 'After granting, you must **fully quit Open Typeless Harness** and reopen it (a macOS TCC requirement).',
    footerHint: 'This onboarding closes automatically once both permissions are granted. If it persists, quit Open Typeless Harness from the menu bar and relaunch.',
  },
  overview: {
    kicker: 'TODAY',
    title: 'Voice input that learns how you write',
    desc: 'Open Typeless watches real post-insertion edits, distills stable corrections into local speech skills, then injects them before later polish.',
    heroBadge: 'Learning Harness v0.1',
    heroProof: '{{skills}} local skills · {{candidates}} candidates today',
    heroPrimary: 'Every correction becomes training evidence',
    heroSecondary: 'High-confidence signals learn automatically. Uncertain candidates wait for your review. Evidence stays local by default.',
    heroStepListen: 'Listen',
    heroStepPolish: 'Polish',
    heroStepLearn: 'Learn',
    heroStepAdapt: 'Adapt',
    loopTitle: 'Today’s input loop',
    loopDesc: 'ASR transcript -> LLM polish -> cursor insertion -> post-edit monitoring -> local memory.',
    loopAsr: 'ASR',
    loopPolish: 'Polish',
    loopMonitor: 'Monitor',
    loopSkill: 'Speech skills',
    pressPrefix: 'Press',
    ...
    providerHealthOk: 'Available',
    providerHealthUnknown: 'Needs check',
    providerHealthUnstable: 'Unstable',
    providerHealthDown: 'Unavailable',
    providerHealthCheckedAt: 'Verified at {{time}}',
    providerHealthLastCheckedAt: 'Last checked at {{time}}',
    ...
    learningTitle: 'Today’s learning loop',
    learningDesc: 'This is the core feedback surface: what the harness captured today, what it learned, and what still needs your confirmation.',
    learningFeedbackAuto: 'Just learned: {{from}} → {{to}}',
    learningFeedbackReview: 'Found one habit candidate. It will affect future input only after confirmation.',
    learningLoading: 'Reading local learning signals…',
    learningSummary: 'Captured {{edits}} edits and {{accepted}} accepted no-edit trajectories today; distilled {{candidates}} candidates; {{skills}} local skills can keep shaping future polish.',
    learningQueue: '{{count}} low-confidence candidates stay in observation before they can affect your habit library.',
    learningQueueClean: 'No low-confidence candidates are quarantined today.',
    learningWeakHotwords: 'Weak-feedback terms',
    learningClean: 'Clean signal',
    learningGuarded: '{{count}} guarded signals',
    learningMetricMonitors: 'Monitor sessions',
    learningMetricEdits: 'Edit events',
    learningMetricAccepted: 'Accepted',
    learningMetricCandidates: 'Candidates',
    learningMetricSkills: 'Local skills',
    learningCandidatesTitle: 'Learning candidates',
    learningSignalsTitle: 'Guardrail signals',
    learningSignalsEmpty: 'No guardrail events today.',
    learningEmpty: 'No learning candidates yet. Correct an inserted transcript within the monitor window to create the first evidence card.',
    learningConfidenceLow: 'Needs review',
    learningConfidenceMedium: 'Learnable',
    learningConfidenceHigh: 'Stable',
    learningStatusNeedsReview: 'Needs review',
    learningStatusAutoLearned: 'Auto-learned',
    learningStatusConfirmed: 'Confirmed',
    learningActionConfirm: 'Confirm learning',
    learningActionEdit: 'Edit',
    learningActionSave: 'Save and learn',
    learningActionCancel: 'Cancel',
    learningActionIgnore: 'Ignore',
    learningEditFrom: 'Heard as',
    learningEditTo: 'Learn as',
    learningSignalInitialQueryFailed: 'Input field unavailable; protected fallback used',
    learningSignalKeyboardFallbackStart: 'Keyboard fallback started',
    learningSignalKeyboardFallbackTimeout: 'Keyboard fallback ended',
    learningSignalTargetFieldUnrelated: 'Unrelated field value ignored',
    learningSignalKeyboardFallbackUnavailable: 'Keyboard fallback unavailable',
  ...
  settings: {
    ...
    recording: {
      ...
      startupAtBootDesc: 'Start Open Typeless Harness automatically when you sign in. macOS uses a LaunchAgent, Linux writes ~/.config/autostart, Windows writes HKCU\\Run (no admin required).',
    ...
    shortcuts: {
      ...
      openApp: 'Open Open Typeless',
      confirmHint: 'Click ✓ on the capsule',
      notSupported: 'Not yet supported',
    },
    permissions: {
      title: 'Permissions',
      descAcc: 'Open Typeless Harness needs the following system permissions to work. After granting, fully quit and relaunch the app for changes to take effect.',
      descNoAcc: 'Open Typeless Harness needs microphone access and uses the global hotkey listener state to verify the native hook is running.',
      micLabel: 'Microphone',
      micDesc: 'Used to capture your voice input.',
      ...
      windowsImeDesc: 'Temporarily switches to the bundled TSF IME during voice sessions to avoid clipboard insertion limits.',
      windowsImeInstalled: 'Installed',
      windowsImeUnavailable: 'Unavailable',
      windowsIme: {
        installed: 'Installed. Voice input temporarily switches to the bundled IME.',
        notInstalled: 'Not installed. The app is using the clipboard/WM_PASTE fallback.',
        registrationBroken: 'Registration is broken. Reinstall the bundled IME.',
    ...
    about: {
      ...
      privacy: 'Privacy',
      privacyDesc: 'Transcripts, edit-monitor evidence, and speech skills stay on this device. Cloud APIs are only called for real-time transcription/polish; no recordings are retained.',
      localFirst: 'Local-first',
      learning: 'Learning layer',
      learningDesc: 'Post-insertion edits are distilled into local speech skills and retrieved before later LLM polish.',
      learningLocal: 'Local speech skills',
      updateDialog: {
        available: {
          title: 'Update available',
          desc: 'Open Typeless Harness {{version}} is available. Update now?',
        },
        downloading: {
          title: 'Downloading update',
          desc: 'Downloading Open Typeless Harness {{version}}. Keep the app open.',
        },
        downloaded: {
          title: 'Update ready',
          desc: 'Open Typeless Harness {{version}} has been installed. Restart automatically now to apply it?',
        },
        installing: {
          title: 'Installing update',
          desc: 'Installing Open Typeless Harness {{version}}. Keep the app open.',
        },
        install: 'Update now',
  ...
  modal: {
    ...
    account: {
      ...
      footer: 'Open Typeless Harness runs locally by default. Speech skills and correction evidence stay on this machine unless you explicitly export them.',
    },
    personalize: {
    ...
    about: {
      ...
      privacy: 'Privacy',
      privacyDesc: 'Transcripts, edit-monitor evidence, and speech skills stay on this device. Cloud APIs are used only for real-time calls.',
      localFirst: 'Local-first',
    },
  },
  windowChrome: {
