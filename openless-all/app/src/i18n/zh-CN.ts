...
export const zhCN = {
  ...
  overview: {
    kicker: 'HARNESS',
    title: '自适应语音输入',
    desc: '在任意输入框口述，先经 LLM 润色插入，再从插入后的人工改动里安静学习。',
    loopTitle: '自学习输入闭环',
    loopDesc: 'ASR 转写 -> LLM 润色 -> 聚焦输入框监控 -> speech skill 记忆，下次口述前检索注入。',
    loopAsr: 'ASR',
    loopPolish: '润色',
    loopMonitor: '监控',
    ...
    learningDesc: '来自插入后人工改动的本地证据。这里展示捕捉到的修改、沉淀出的候选，以及防误学习护栏是否生效。',
    ...
    learningCandidatesTitle: '最近候选',
    learningSignalsTitle: '最近护栏',
