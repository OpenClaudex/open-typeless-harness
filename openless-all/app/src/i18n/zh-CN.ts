...
export const zhCN = {
  ...
  shell: {
    ...
    shortcutHint: '开始 / 停止',
    betaTag: 'BETA',
    betaNote: '输入框监控与 speech skill 学习仍是本地预览能力。',
    footer: {
      account: '账户',
      feedback: '反馈',
      settings: '设置',
  ...
  onboarding: {
    welcome: '欢迎使用 Open Typeless Harness',
    intro: '说出、润色、插入，再从你的改动里本地学习。开始前需要两个系统权限。',
    ...
    accessibilityHint: '授权后必须**完全退出 Open Typeless Harness** 再重新打开（macOS TCC 规则）。',
    footerHint: '授权全部完成后此引导自动关闭。如果一直不消失，从菜单栏 Open Typeless Harness → 退出，重新打开 App。',
  },
  overview: {
    kicker: 'TODAY',
    title: '让输入法每天变得更懂你',
    desc: 'Open Typeless 会观察你插入后的真实修改，把稳定纠错沉淀成本地 speech skills，下次口述前自动带上。',
    heroBadge: 'Learning Harness v0.1',
    heroProof: '{{skills}} 个本地技能 · {{candidates}} 个今日候选',
    heroPrimary: '每次修正都是训练样本',
    heroSecondary: '高置信度自动学习，不确定的候选留给你确认；所有证据默认留在本机。',
    heroStepListen: 'Listen',
    heroStepPolish: 'Polish',
    heroStepLearn: 'Learn',
    heroStepAdapt: 'Adapt',
    loopTitle: '今日输入闭环',
    loopDesc: 'ASR 转写 -> LLM 润色 -> 插入当前光标 -> 监控人工修改 -> 写入本地记忆。',
    loopAsr: 'ASR',
    loopPolish: '润色',
    loopMonitor: '监控',
    ...
    providerHealthOk: '可用',
    providerHealthUnknown: '待验证',
    providerHealthUnstable: '不稳定',
    providerHealthDown: '当前不可用',
    providerHealthCheckedAt: '{{time}} 验证通过',
    providerHealthLastCheckedAt: '{{time}} 最近检测',
    metricChars: '今日字数',
    ...
    learningTitle: '今日学习闭环',
    learningDesc: '这里是产品的核心反馈区：它展示系统今天从你身上捕捉到哪些修改、哪些已经学会、哪些还需要确认。',
    learningFeedbackAuto: '刚刚学会：{{from}} → {{to}}',
    learningFeedbackReview: '发现 1 条待确认习惯，确认后才会影响后续输入。',
    learningLoading: '正在读取本机学习信号…',
    learningSummary: '今天捕捉 {{edits}} 次改动，{{accepted}} 次无改动接受，沉淀 {{candidates}} 个候选；{{skills}} 个本地技能会继续影响后续润色。',
    learningQueue: '{{count}} 个低置信候选先留在观察区，不会直接污染你的习惯库。',
    learningQueueClean: '今天没有低置信候选被隔离。',
    learningWeakHotwords: '弱反馈热词',
    learningClean: '信号干净',
    learningGuarded: '{{count}} 个护栏信号',
    learningMetricMonitors: '监控会话',
    learningMetricEdits: '编辑事件',
    learningMetricAccepted: '接受轨迹',
    learningMetricCandidates: '学习候选',
    learningMetricSkills: '本地技能',
    learningCandidatesTitle: '待学习候选',
    learningSignalsTitle: '护栏信号',
    learningSignalsEmpty: '今天还没有护栏事件。',
    learningEmpty: '还没有学习候选。插入后在监控窗口内修正一次文本，就会生成第一张证据卡。',
    learningConfidenceLow: '待确认',
    learningConfidenceMedium: '可学习',
    learningConfidenceHigh: '稳定',
    learningStatusNeedsReview: '待确认',
    learningStatusAutoLearned: '已自动学习',
    learningStatusConfirmed: '已确认学习',
    learningActionConfirm: '确认学习',
    learningActionEdit: '编辑',
    learningActionSave: '保存并学习',
    learningActionCancel: '取消',
    learningActionIgnore: '忽略',
    learningEditFrom: '原识别',
    learningEditTo: '应改为',
    learningSignalInitialQueryFailed: '无法读取输入框，已降级保护',
    learningSignalKeyboardFallbackStart: '键盘 fallback 已启动',
    learningSignalKeyboardFallbackTimeout: '键盘 fallback 已结束',
    learningSignalTargetFieldUnrelated: '已忽略无关输入框内容',
    learningSignalKeyboardFallbackUnavailable: '键盘 fallback 不可用',
  ...
  settings: {
    ...
    recording: {
      ...
      startupAtBoot: '开机自启',
      startupAtBootDesc: '登录后自动启动 Open Typeless Harness。macOS 写 LaunchAgent，Linux 写 ~/.config/autostart，Windows 写 HKCU\\Run（不需要管理员）。',
    ...
    shortcuts: {
      ...
      confirm: '胶囊确认插入',
      switchStyle: '切换上一次风格',
      openApp: '打开 Open Typeless',
      confirmHint: '点击右侧 ✓',
      notSupported: '暂未支持',
    },
    permissions: {
      title: '权限',
      descAcc: 'Open Typeless Harness 需要以下系统权限才能正常工作。授权后通常需要完全退出 App 重启一次才生效。',
      descNoAcc: 'Open Typeless Harness 需要麦克风可用，并依赖全局快捷键监听状态判断 native hook 是否正常工作。',
      micLabel: '麦克风',
      micDesc: '用于捕获你的语音输入。',
      accLabel: '辅助功能',
      ...
      windowsImeDesc: '用于在语音会话期间临时切换到内置 TSF 输入法，避免剪贴板插入限制。',
      windowsImeInstalled: '已安装',
      windowsImeUnavailable: '不可用',
      windowsIme: {
        installed: '已安装。语音输入时会临时切换到内置输入法。',
        notInstalled: '未安装。当前正在使用剪贴板 / WM_PASTE 兜底。',
        registrationBroken: '注册已损坏。请重新安装内置输入法。',
    ...
    about: {
      ...
      copyQq: '复制群号',
      privacy: '隐私',
      privacyDesc: '识别结果、输入框改动证据和 speech skills 都保存在本机。云端 API 仅用于实时转写与润色，不会保留你的录音。',
      localFirst: '本地优先',
      learning: '学习层',
      learningDesc: '插入后的人工改动会被异步归纳成本地 speech skill，后续润色前按语境检索注入。',
      learningLocal: '本地 Speech Skills',
      updateDialog: {
        available: {
          title: '发现新版本',
          desc: '发现 Open Typeless Harness {{version}}，是否现在更新？',
        },
        downloading: {
          title: '正在下载更新',
          desc: '正在下载 Open Typeless Harness {{version}}，请保持应用打开。',
        },
        downloaded: {
          title: '更新已准备好',
          desc: 'Open Typeless Harness {{version}} 已安装完成。是否现在自动重启以应用更新？',
        },
        installing: {
          title: '正在安装更新',
          desc: '正在安装 Open Typeless Harness {{version}}，请保持应用打开。',
        },
        install: '现在更新',
  ...
  modal: {
    ...
    account: {
      ...
      loginSync: '登录 / 同步',
      footer: 'Open Typeless Harness 默认本地运行。Speech skill 与纠错证据都保存在本机，除非你显式导出。',
    },
    personalize: {
      appearance: '外观',
    ...
    about: {
      ...
      privacy: '隐私',
      privacyDesc: '识别结果、输入框改动证据和 speech skills 都保存在本机，云端 API 仅用于实时调用。',
      localFirst: '本地优先',
    },
  },
  windowChrome: {
