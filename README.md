...
<p align="center">
  • 🎙️ Focused-Field Dictation • ✨ LLM Polish • 🧠 Local Speech Skills •
</p>
...
>
> **🛠️ For builders** -> The product loop is `ASR transcript -> LLM polish -> focused-field insertion -> edit monitor -> local speech skills`.
...
- **🎙️ Focused-field dictation**: speak into the app you are already using instead of switching to a separate editor.
...
| --- | --- | --- |
| 🎙️ Listen | Capture speech and produce an ASR transcript. | The user stays in the current writing context. |
...
- 🏗️ Built on top of the OpenLess desktop runtime.
